...
Genres.create(name: "Chinese")
Genres.create(name: "Hawaiian")
Genres.create(name: "Korean")
Genres.create(name: "Indian")
Genres.create(name: "Polynesian")
Genres.create(name: "Japanese")
